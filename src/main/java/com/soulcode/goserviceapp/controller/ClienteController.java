...
import java.util.List;
    ...
    public class ClienteController {
        ...
        public String cancelarAgendamento(@RequestParam(name = "agendamentoId") Long agendamentoId,
                                          Authentication authentication,
                                          RedirectAttributes attributes){
            try{
        ...
        public String concluirAgendamento (@RequestParam(name="agendamentoId") Long agendamentoId,
                                           Authentication authentication,
                                           RedirectAttributes attributes){
            try{
                ...
                attributes.addFlashAttribute("errorMessage", "Erro ao concluir o agendamento.");
            }
            return "redirect:/cliente/historico";
        }
    }
