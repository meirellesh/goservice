...
public class UsuarioService {
    ...
    private Prestador createAndSavePrestador(Usuario u) {
        Prestador prestador = new Prestador(u.getId(), u.getNome(), u.getEmail(), u.getSenha(), u.getHabilitado(), u.getPerfil(), u.getEndereco());
    ...
    public Page<Usuario> findUsersByPage(Pageable pageable) {
